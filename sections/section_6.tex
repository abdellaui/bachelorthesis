...
% Motivieren
Ein Lokalisierungsansatz innerhalb von Gebäuden mit einer Positionsakkuratesse von ca. 11$m$ ist undenkbar. 
...
Nichtsdestoweniger könnte eine möglich pedestration or personell möglich.

Außerdem könnte die Pose lokal mit einem Kaskadeneffekt z.B. über weiterführenden Netzwerken oder modellbasierten Ansätzen korrigiert werden.
% OUTLOOK
