...
% Motivieren
Eine potenzielle Positionsakkuratesse auf den hier erhobenen Datensätzen von 1$m$ durch PoseNet ist im direkten Gebrauch unzureichend für Anwendungen wie die automatische Bauforstschritterfassung sowie das Facility-Manage\-ment und die Navigation über Augmented Reality. 

Allerdings wäre eine möglich..


Außerdem könnte die Pose lokal durch einen Kaskadeneffekt z.B. über weiterführenden Netzwerken oder modellbasierten Ansätzen korrigiert werden.
% OUTLOOK
