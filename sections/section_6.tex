...
% Motivieren
Ein Lokalisierungsansatz innerhalb von Gebäuden mit einer Positionsakkuratesse von ca. 11$m$ ist undenkbar. Ferner ist eine potenzielle Positionsakkuratesse von 1$m$ im direkten Gebrauch für Anwendungen wie die automatische Bauforstschritterfassung sowie das Facility-Manage\-ment und die Navigation über Augmented Reality unzureichend. Hierbei könnte allerdings die Pose mit einem Kaskadeneffekt z.B. über weiterführenden Netzwerken oder modellbasierten Ansätzen lokal skorrigiert werden.
% OUTLOOK
