...
sind image retivial oder pose regression. Diese Verfahren benötigen entweder eine Datenbanken aus Bildern mit bekannten Posen oder zusätzlich Daten wie die 3D Punktwolke oder Tiefenbilder der Szene. Allerdings ist die Beschaffung der Daten mit bekannter Pose bei großen Gebäuden zeit- und kostenaufwendig.
%
