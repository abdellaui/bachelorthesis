...
Folgendes konnte in der vorliegenden Arbeit erreicht werden:
\begin{itemize}
	\item
	Es wurden insgesamt vier Datensätze mit realen und synthetischen Daten aus den Innenräumen zwei verschiedener Gebäuden erhoben.
	\item 
PostNet bei gleichen Hyperparametern wie in \cite{acharyaBIMPoseNetIndoorCamera2019} mit den Gradientenbildern der simulierten Daten für die Evaluation mit den Gradientenbildern der realen Daten auf einem begrenzten Gebäudeareal nur in eine Richtung trainiert werden kann.
	\item
	placeholder
\end{itemize}
