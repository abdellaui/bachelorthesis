...
sind image retivial oder pose regression. Diese Verfahren benötigen benötigen Datenbanken von Bildern mit korrespondierenden Pose. Allerdings ist die Beschaffung der Daten mit bekannter Pose bei großen Gebäuden zeit- und kostenaufwendig.
%
