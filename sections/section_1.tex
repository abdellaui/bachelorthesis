...
visuelle Odemetrie (\textit{VO}) oder Simultaneous-Localization-and-Mapping (\textit{SLAM}), benötigen die Ausgangsposition des Sensors, um die absolute Position im Gebäude lokalisieren zu können \cite{stephenseGlobalLocalizationUsing2002}.
\\\\
