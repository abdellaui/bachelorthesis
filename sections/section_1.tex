...
%ziele
%results
Hierfür eignen sich Ansätze mit künstliche neuronale Netzwerken wie z.B. PoseNet \cite{kendallPoseNetConvolutionalNetwork2015}. PoseNet kann mit Datensätzen bestehend aus Paaren von RGB-Bildern und Pose, die über Structure-from-Motion (\textit{SfM}) ermittelt wurden, trainiert werden.
