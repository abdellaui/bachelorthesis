...
Die Evaluationsergebnisse der trainierten künstlichen neuronale Netzwerken werden in Kapitel \ref{sec:kapitel_4} präsentiert. In Kapitel \ref{sec:kapitel_5} werden die Ergebnisse disktuiert. Abschließend wird in Kapitel \ref{sec:kapitel_6} ein Fazit gezogen. 
