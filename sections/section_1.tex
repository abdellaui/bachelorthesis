...
%ziele
%results
Hierfür eignen sich Ansätze mit künstliche neuronale Netzwerken wie z.B. PoseNet \cite{kendallPoseNetConvolutionalNetwork2015}. PoseNet kann mit RGB-Bildern und die dazu korrespondierende Pose trainiert werden. Die Pose der Bilder kann dabei vom Structure-from-Motion (\textit{SfM}) einer  Video-Aufnahme ermittelt werden.
