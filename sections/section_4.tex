...
\begin{table}
	\centering
	\caption{Zusammenfassung der Ergebnisse. Die Referenzwerte wurden während der Bestimmung des Hyperparameters $\beta$ durch das Trainieren und Evaluieren mit den \textit{realen} Daten ermittelt. Experiment 1 und 2 evaluieren die mit den Gradientenbildern der synthetischen Daten trainierten Netzwerke. Experiment 1 evaluiert mit den korrespondierenden Gradientenbildern der synthetischen Daten. Experiment 2 evaluiert mit den Gradientenbildern der realen Daten.}
