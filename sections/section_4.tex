...
\begin{table}
	\centering
	\caption{Evaluationsergebnisse von der \textit{IC-loop} Strecke. Die Akkuratesse der mit den jeweiligen Trainingsdaten trainierten Netzwerken wird angegeben. Diese Netzwerke wurde mit den korrespondierenden synthetischen Evaluationsdaten und jeweils mit den realen Evaluationsdaten evaluiert.}
