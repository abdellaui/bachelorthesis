...
\begin{figure}
	...
	\end{tabularx}
	\caption{Visualisierung der Evaluationsergebnisse von der Strecke \textit{IC-loop}. \subref{subfig:ic_fig2} illustriert die Positionen, die von dem KNN bestimmt wurden. \subref{subfig:ic_fig4} stellt den Positionsfehler und \subref{subfig:ic_fig6} den Orientierungsfehler von den jeweiligen Evaluierungsdaten dar. }
