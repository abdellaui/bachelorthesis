...
\begin{table}
	...
	\begin{tabularx}{0.6\textwidth}{X X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild)& \textbf{Akkuratesse} \hspace{2cm} (Position, Orientierung)\\
		\hline
		karikaturistische Simulation & 2.57$m$, 10.52°\\
		\hline
		synthetisches Kantenbild & 2.57$m$, 10.52°\\
\hline
		fotorealistische Simulation & 2.57$m$, 10.52°\\
	\end{tabularx}
