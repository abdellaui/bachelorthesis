...
Weiterhin wurde ein Experiment mit dem \textit{HS-stairs-up} Datensatz durchgeführt. Ausschließlich mit synthetischen Daten konnte eine Akkuratesse von 0.82$m$ in der Position und 7.76° in der Orientierung durch die \texit{grad-cartoon} Daten erzielt werden (vgl. Tab. \ref{tab:results_hs_stairs_up}). besitzt dieses Experiment ebenso das Potenzial zur Pose Estimation.

Bei der Evaluierung, mit den \textit{grad-real} Evaluationsdaten, konnte eine Akkuratesse von 4.33$m$ in der Position und 51.64° in der Orientierung durch das mit \textit{grad-edge} trainierte Netzwerk erreicht werden. Sowohl ein Positionsfehler von 4.33$m$ als auch ein Orientierungsfehler von 51.64°  in einem ca. $12m \times 12m \times 12m$ großen Zone führen keinesfalls zur Bestimmung der wirklichen Position.
