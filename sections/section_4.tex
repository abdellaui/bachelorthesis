...
Für jeder synthetische Datensatz wurde das Netzwerk seperat mit den Gradientenbilder trainiert. Eine Evaluierung folgt mit den Gradientenbilder der korrespondierenden synthetischen sowie realen Evaluationsdaten. Tabelle \ref{tab:results_ic} bis \ref{tab:results_hs_stairs_down} geben die Evaluationsergebnisse der jeweiligen Strecken (s. Tabelle \ref{tab:dataset_metrics}) an.
\begin{table}
	\centering
