...
\begin{table}
	...
	\begin{tabularx}{1.0\textwidth}{>{\hsize=1.1\hsize}X >{\hsize=0.9\hsize}X >{\hsize=0.9\hsize}X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild)& \textbf{\textit{synthetisch}} \hspace{2cm} (Position, Orientierung) & \textbf{\textit{real}} \hspace{2cm} (Position, Orientierung)\\
		\hline
