...
In diesem Experiment wurden über die \textit{IC-loop} Strecke, die eine geschlossen Schleife in einem optisch ähnlichen Gang bildet, der Ansatz von \citet{acharyaBIMPoseNetIndoorCamera2019} auf eine, in mehrere Richtungen verlaufende, längere Strecke mit wiederholenden Gebäudemerkmalen untersucht. Alle Datensätze der Strecke \textit{IC-loop} wurden zu 50\% Trainingsdaten und zu 50\% Evalierungsdaten zufällig aufgeteilt. Es wurde für alle synthetischen Datensatztypen mit je 5718 Daten ein Netzwerk trainiert. Anschließend wurden die Netzwerke mit den korrespondierenden synthetischen Evaluierungsdatensätze mit je 5717 Daten getestet. Eine weitere Evaluierung der trainierten Netzwerke folgte mit den realen 1921 Evaluierungsdaten. Tabelle \ref{tab:results_ic} gibt die Ergebnisse dieser Evaluierungsvorgänge an.
