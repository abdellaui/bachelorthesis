...
\begin{table}
	...
	\begin{tabularx}{1.0\textwidth}{>{\hsize=1.0\hsize}X >{\hsize=1.0\hsize}X >{\hsize=1.0\hsize}X}
		\textbf{Strecke} & \textbf{Datensatztyp} \hspace{2cm} (Position, Gradientenbild)& \textbf{Akkuratesse} \hspace{2cm} (Position, Orientierung)\\
		\hline
		Batchsize & $40$ & $d$\\
	\end{tabularx}
	\label{tab:betas}
