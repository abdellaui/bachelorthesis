...
\begin{table}
	...
	\begin{tabularx}{0.7\textwidth}{X >{\RaggedRight}X >{\RaggedRight}X >{\RaggedRight}X}
		\textbf{Strecke} & \textbf{Referenzwert} \hspace{2cm} (Position, Orientierung) & \textbf{synth} \hspace{2cm} (Position, Orientierung) & \textbf{real vs synth} \hspace{2cm} (Position, Orientierung)\\
		\hline
		\textit{IC-loop} & 1.93$m$, 4.26° & 1.93$m$, 4.26° & 1.93$m$, 4.26°\\
		\hline
		\textit{HS-gamma} & 0.95$m$, 7.53° & 1.93$m$, 4.26° & 1.93$m$, 4.26°\\
		\hline
		\textit{HS-stairs-up} & 0.94$m$, 8.33° & 1.93$m$, 4.26° & 1.93$m$, 4.26°\\
		\hline
		\textit{HS-stairs-down} & 0.87$m$, 9.25° & 1.93$m$, 4.26° & 1.93$m$, 4.26°\\
		\hhline{|=|=|=|=|}
