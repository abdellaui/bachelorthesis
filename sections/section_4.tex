...
\section{Ergebnisse}
Im vorliegenden Kapitel werden die Ergebnisse der durchgeführten Experimente präsentiert. Zuallererst wurden die Ergebnisse von BIM-PoseNet reproduziert, um die Korrektheit der Pipeline zu überprüfen. Daher werden die Ergebnisse der Reproduktion zuerst repräsentiert. Anschließen wird der Hyperparameter $\beta$ der Kostenfunktion (vgl. Gleichung \ref{eq:posenet_loss}) für jedes der Datensätze (siehe Abschnitt \ref{subsec:generate_synth_images}) bestimmt. 
