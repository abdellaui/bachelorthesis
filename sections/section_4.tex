...
\begin{table}
	\centering
	\caption{Die Referenzwerte wurden während der Bestimmung des Hyperparameters $\beta$ durch das Trainieren und Evaluieren mit den \textit{realen} Daten ermittelt. Evaluation 1 und 2 bezog sich auf die zuvor mit den Gradientenbildern der synthetischen Daten trainierten Netzwerke. Evaluation 1 erfolgte mit den korrespondierenden Gradientenbildern der synthetischen Daten. Evaluation 2 erfolgte mit den Gradientenbildern der realen Daten.}
