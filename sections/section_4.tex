...
In Abbildung \ref{subfig:ic_fig2} ist deutlich zu erkennen, dass das mit \textit{grad-photoreal} trainierte Netzwerk die Position der \textit{grad-real} Evaluierungsdaten nur auf ein Teil der unteren horizontalen Strecke bestimmt hat. Daher weisen die kürzeren vertikalen Strecken sowie die obige horizontale Strecke die größten Positionsfehler auf, wie in Abbildung \ref{subfig:ic_fig4} dargestellt wird.
