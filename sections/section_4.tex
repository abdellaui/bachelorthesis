...
\begin{table}
	\centering
	\caption{Zusammenfassung der Ergebnisse. Die Referenzwerte wurden während der Bestimmung des $\beta$ Hyperparameters durch das Trainieren und Evaluieren mit den \textit{realen} Daten ermittelt. Experiment 1 evaluiert mit den Gradientenbildern der synthetischen Daten. Experiment 2 evaluiert mit den Gradientenbildern der realen Daten.}
