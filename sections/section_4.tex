...
\begin{table}
	\centering
	\caption{Zusammenfassung der Ergebnisse. Die Referenzwerte wurden während der Bestimmung des $\beta$ Hyperparameters (s. Abschn. \ref{sec:trainingsparameter}) durch das Trainieren und Evaluieren mit den \textit{realen} Daten ermittelt. Die Durchschnittswerte von Experiment 1 geben durch das Trainieren und Evaluieren mit den synthetischen Daten ermittelte Akkuratesse an.}
