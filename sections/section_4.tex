...
Für jeder synthetische Datensatz wurde das Netzwerk seperat 5-mal mit den Gradientenbilder trainiert. Eine Evaluierung folgte mit den Gradientenbilder der korrespondierenden synthetischen sowie realen Evaluationsdaten. Es wurden nur die besten Ergebnisse behalten. Tabelle \ref{tab:results_ic} bis \ref{tab:results_hs_stairs_down} geben die Evaluationsergebnisse der jeweiligen Strecken (s. Tabelle \ref{tab:dataset_metrics}) an.
\begin{table}
	\centering
