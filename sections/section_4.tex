...
\begin{table}
	...
	\begin{tabularx}{1.0\textwidth}{X X X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild) & \textbf{synthetische Daten} \hspace{1cm} (Position, Orientierung) & \textbf{real Daten} \hspace{2cm} (Position, Orientierung)\\
		\hline
