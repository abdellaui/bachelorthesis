...
\section{Ergebnisse}
Im vorliegenden Kapitel werden die Ergebnisse der durchgeführten Experimente präsentiert. In dieser Arbeit gibt ein Evaluationsergebnis die Abweichung der Position in Metern sowie Orientierung in Grad an. Weiterhin wird die Akkuratesse eines KNNs durch den Median der Evaluationsergebnisse bestimmt. Somit bildet sich die Akkuratesse eines Netzwerkes aus der Zusammensetzung von Positions- sowie Orientierungsfehler. Zudem wird in dieser Arbeit ein Evaluationsergebnis und eine Akkuratesse gegenüber Seinesgleichen anhand des Positionsfehlers verglichen.
