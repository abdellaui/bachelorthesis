...
\begin{figure}
	...
	\end{tabularx}
	\caption{Visualisierung der Evaluationsergebnisse von der Strecke \textit{IC-loop}. Die Evaluation folgte mit den Gradietenbildern der realen Daten auf das mit den Gradientenbildern der fotorealistischen Simulation trainierten Netzwerk. \subref{subfig:ic_fig2} illustriert die Positionen, die von dem KNN bestimmt wurden. Die Positions- und Orientierungsfehler der jeweiligen Evaluierungsdaten werden in  \subref{subfig:ic_fig4} und  \subref{subfig:ic_fig6} dargestellt.}
...
\begin{figure}
	...
	\end{tabularx}
	\caption{Visualisierung der Evaluationsergebnisse von der Strecke \textit{HS-gamma}. Die Evaluation folgte mit den Gradietenbilder der realen Daten auf das mit den Gradientenbildern der karikaturistischen Simulation trainierten Netzwerk. \subref{subfig:hs_gamma_fig2} illustriert die Positionen, die von dem KNN bestimmt wurden. Die Positions- und Orientierungsfehler der jeweiligen Evaluierungsdaten werden in  \subref{subfig:hs_gamma_fig4} und  \subref{subfig:hs_gamma_fig6} dargestellt.}
