...
\section{Ergebnisse}
Im vorliegenden Kapitel werden die Ergebnisse der durchgeführten Experimente präsentiert. Zuallererst werden die Ergebnisse des Reproduktions von BIM-PoseNet \cite{acharyaBIMPoseNetIndoorCamera2019} angegeben. Danach wurde das neuronale Netz separat für alle synthetische Datensätze mit den Gradientenbilder trainiert. Anschließend wurde das neuronale Netz mit den korrespondieren Gradientenbilder der synthetischen Daten evaluiert.
