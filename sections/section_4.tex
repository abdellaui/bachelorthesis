...
\begin{table}
	...
	\begin{tabularx}{1.0\textwidth}{X X X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild)& \textbf{\textit{synthetisch Daten}} \hspace{2cm} (Position, Orientierung) & \textbf{\textit{real Daten}} \hspace{4cm} (Position, Orientierung)\\
		\hline
