...
In Abbildung \ref{subfig:ic_fig2} ist deutlich zu erkennen, dass das mit \textit{grad-photoreal} trainierte Netzwerk die Position der \textit(grad-real) Evalierungdaten nur auf ein Teil der unteren Strecke bestimmt hat.
