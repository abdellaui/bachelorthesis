...
\begin{table}
	\centering
	\caption{Evaluationsergebnisse von IC-loop (synth vs synt).}
...
\begin{table}
	\centering
	\caption{Evaluationsergebnisse von HS-gamma (synth vs synt).}
	\begin{tabularx}{0.75\textwidth}{X X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild)& \textbf{Akkuratesse} \hspace{2cm} (Position, Orientierung)\\
		\hline
...
\begin{table}
	\centering
	\caption{Evaluationsergebnisse von HS-stairs-up (synth vs synt).}
	\begin{tabularx}{0.75\textwidth}{X X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild)& \textbf{Akkuratesse} \hspace{2cm} (Position, Orientierung)\\
		\hline
...
\begin{table}
	\centering
	\caption{Evaluationsergebnisse von HS-stairs-down (synth vs synt).}
	\begin{tabularx}{0.75\textwidth}{X X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild)& \textbf{Akkuratesse} \hspace{2cm} (Position, Orientierung)\\
		\hline
...
\begin{table}
	...
	\begin{tabularx}{0.75\textwidth}{X X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild)& \textbf{Akkuratesse} \hspace{2cm} (Position, Orientierung)\\
		...
		\hline
		synthetisches Kantenbild & 5.25$m$, 32.70°\\
		\hline
