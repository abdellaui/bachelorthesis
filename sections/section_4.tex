...
\begin{table}
	...
	\begin{tabularx}{1.0\textwidth}{X X X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild)& \textbf{\textit{synthetische Datensatz}} \hspace{2cm} (Position, Orientierung) & \textbf{\textit{reale Datensatz}} \hspace{2cm} (Position, Orientierung)\\
		\hline
