...
\begin{table}
	...
	\begin{tabularx}{1.0\textwidth}{X >{\RaggedRight}X}
		\textbf{Strecke} & \textbf{Akkuratesse} \hspace{2cm} (Position, Orientierung)
		\hline
		\textit{IC-loop} & 1.61$m$, 8.17° & 23.56$m$, 51.30°\\
		\hline
		\textit{HS-gamma} & 2.00$m$, 8.29° & 32.91$m$, 59.17°\\
		\hline
		\textit{HS-stairs-up} & 1.80$m$, 7.70° & 16.68$m$, 73.25°\\
		\hline
		\textit{HS-stairs-down} & 1.80$m$, 7.70° & 16.68$m$, 73.25°\\
		\hhline{|=|=|=|}
		Durchschnitt & 1.80$m$, 8.05° & 24.38$m$, 61.24°\\
	\end{tabularx}
	\label{tab:results_ic_real}
\end{table}
