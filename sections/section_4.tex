...
In Abbildung \ref{subfig:ic_fig2} ist deutlich zu erkennen, dass das mit \textit{grad-photoreal} trainiertem Netzwerk nur begrenzt auf der unteren Strecke die Position der \textit(grad-real) Evalierungdaten bestimmen kann.
