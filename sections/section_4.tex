...
Bei der Evaluierung, mit den \textit{grad-real} Evaluationsdaten, konnte eine Akkuratesse von 4.33$m$ in der Position und 51.64° in der Orientierung durch das mit \textit{grad-edge} trainierte Netzwerk erreicht werden. Sowohl ein Positionsfehler von 4.33$m$ als auch ein Orientierungsfehler von 51.64°  in einem ca. $12m \times 12m \times 12m$ großen Zone führen keinesfalls zur Bestimmung der Pose.
