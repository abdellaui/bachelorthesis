...
\begin{figure}
	...
	\end{tabularx}
	\caption{Visualisierung der Evaluationsergebnisse von der Strecke \textit{IC-loop}. Es wurde mit den Gradientenbilder der fotorealistischen Simulation trainiert und mit den Gradietenbilder der realen Daten evaluiert. \subref{subfig:ic_fig2} illustriert die Positionen, die von dem KNN bestimmt wurden. Die Positions- und Orientierungsfehler der jeweiligen Evaluierungsdaten werden in  \subref{subfig:ic_fig4} und  \subref{subfig:ic_fig6} dargestellt.}
