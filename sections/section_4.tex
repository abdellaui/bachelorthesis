...
\begin{table}
	\centering
	\caption{Zusammenfassung der Ergebnisse. Die Referenzwerte wurden während der Bestimmung des Hyperparameters $\beta$ durch das Trainieren und Evaluieren mit den \textit{realen} Daten ermittelt. Evaluation 1 und 2 bezog sich auf die zuvor mit den Gradientenbildern der synthetischen Daten trainierten Netzwerke. Evaluation 1 evaluiert mit den korrespondierenden Gradientenbildern der synthetischen Daten. Evaluation 2 evaluiert mit den Gradientenbildern der realen Daten.}
