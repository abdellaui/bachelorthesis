...
\begin{table}
	...
	\begin{tabularx}{1.0\textwidth}{>{\hsize=1.1\hsize}X >{\hsize=0.85\hsize}X >{\hsize=0.85\hsize}X}\textbf{Datensatztyp} \hspace{2cm} (Gradientenbild)& \textbf{\textit{synthetisch}} \hspace{3cm} (Position, Orientierung) & \textbf{\textit{real}} \hspace{3cm} (Position, Orientierung)\\
		\hline
