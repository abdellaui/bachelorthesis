...
Aus Tabelle \ref{tab:results_ic} ist zu erkennen, dass trainiert und evaluiert mit ausschließlich synthetischen Daten eine Akkuratesse von 1.61$m$ in der Position und 8.17° in der Orientierung bei dem Datensatz \textit{grad-cartoon} erreicht werden konnte. Ebenso ist zu erkennen, dass bei der Evaluierung mit den Gradientenbilder der realen Daten eine Akkuratesse von 16.68$m$ in der Position und 73.25° in der Orientierung auf dem mit \textit{grad-photoreal} trainiertem Netzwerk erreicht werden konnte. Abbildung \ref{fig:result_ic_loop} visualisiert die Evaluierungsergebnisse von diesem Netzwerk.
\begin{table}
	\centering
