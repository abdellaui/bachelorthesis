...
In diesem Experiment wurden alle Datensätze der Strecke \textit{IC-loop} zu 50\% Trainingsdaten und zu 50\% Evalierungsdaten zufällig aufgeteilt. Es wurde für alle synthetischen Datensatztypen mit je 5718 Daten ein Netzwerk trainiert. Anschließend wurden die Netzwerke mit den korrespondierenden synthetischen Evaluierungsdatensätze mit je 5717 Daten getestet. Eine weitere Evaluierung folgte mit den realen 1921 Evaluierungsdaten.
