...
% datentypen
Außerdem erzielten \citet{acharyaBIMPoseNetIndoorCamera2019} ihre besten Ergebnissen durch das Trainieren mit den Gradientenbilder der synthetischen Kantenbilder (\textit{grad-edge}). In dieser Arbeit lässt sich ein einheitlicher Typ der synthetischen Daten nicht finden.
