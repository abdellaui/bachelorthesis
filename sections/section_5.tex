...
In Gebäuden kommt es häufiger vor, dass unterschiedliche Stellen eines Innenraumes ähnliche Eigenschaften besitzen. Dies ist in der Literatur auch als perceptual- aliasing-Problem bekannt und stellt einen der größten Herausforderung von Lokalisierungsansätzen \cite{lowryVisualPlaceRecognition2016}.
