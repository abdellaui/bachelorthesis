...
% Beschränlen
Ziel dieser Arbeit ist nicht gewesen, eine Lokalisierungsgenauigkeit im Zentimeterbereich anzustreben. 
Die Akkuratesse eines KNNs ist in dieser Arbeit durch den stochastischen Gradietenabstiegsverfahren \textit{AdaGrad} bei der Optimierung des \textit{Losses} im Trainingsprozess dem Zufall unterworfen. Es würde den Rahmen dieser Bachelorarbeit sprengen, die durch den Zufall bedingten bestmöglichen Akkuratesse zu finden. Daher wurden die zeitintensiven Trainingsprozesse 5-mal wiederholt und die Netzwerke mit den besten Akkuratesse behalten. 


%Die Evaluationsdaten wiesen eine Abweichung (\textit{Drift}) bis zur 5\% auf (s. Abb. \ref{subsec:record_real_data}). Allerdings sind die Ergebnisse

%Empfehlung
Die Hyperparameter wurden überwiegen aus \citet{acharyaBIMPoseNetIndoorCamera2019} übernommen. Die Optimierung der Hyperparameter kann zu besseren Ergebnissen auf den jeweiligen Datensätzen führen und ist daher eine Empfehlung für weitere Forschung. In der Literatur wurden raumzeitliche Informationen aus Bildsequenzen von aufeinanderfolgenden Frames berücksichtigt, um das perceptual-aliasing Problem zu behandeln \cite{walchImageBasedLocalizationUsing2017, clarkVidLocDeepSpatioTemporal2017}. Außerdem wurde PoseNet an einem Bayessian Neural Network angepasst, um die Unsicherheit der Ergebnisse zu modellieren. Dadurch ist es möglich in der Evaluationsphase möglich Ergebnisse zu vertrauen oder zu verwerfen \cite{kendallModellingUncertaintyDeep2016}. Daher können die im Rahmen dieser Bachelorarbeit erhobenen Datensätze auf die PoseNet Nachfolger \cite{kendallModellingUncertaintyDeep2016, walchImageBasedLocalizationUsing2017, clarkVidLocDeepSpatioTemporal2017} angewendet werden und ist ebenso eine Empfehlung für weitere Forschung.
