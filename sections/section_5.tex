...
\citet{acharyaBIMPoseNetIndoorCamera2019} stellten überraschend fest, dass die Akuratesse mit einem zunehmendem \textit{Level of Detail} (LOD) der Gebäudesimulation (\textit{Trainingsdaten}) bei der Evaluation mit den Gradientenbildern der realen Daten zu einer Abnahme führte. Daher könnte die schlechte Generalisierungsfähigkeit des KNNs auf dem \textit{HS-gamma} Datensatz auf die hohe LOD des HS-Gebäudesimulations zurückgeführt werden. Allerdings liegt angesichts der oben genannten Parallelen der Ergebnisse die Schlussfolgerung nahe, dass der visuelle Lokalisierungsansatz über KNN bei gleichen Hyperparametern wie in \citet{acharyaBIMPoseNetIndoorCamera2019} begrenzt auf das Erlenen einer Richtung in einem kleinen Gebäudeareal ist.
