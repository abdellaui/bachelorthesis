...
Die Akkuratesse eines KNNs ist in dieser Arbeit durch den stochastischen Gradietenabstiegsverfahren \textit{AdaGrad} bei der Optimierung des \textit{Losses} im Trainingsprozess vom Zufall abhängig. Es würde den Rahmen dieser Bachelorarbeit sprengen, die durch den Zufall bedingten bestmöglichen Akkuratesse zu finden. Daher wurden die zeitintensiven Trainingsprozesse jeweils für die Strecken und Datentypen 5-mal wiederholt und die Netzwerke mit den besten Akkuratesse behalten. Weiterführende Forschungen können den Anzahl der Trainingsprozesse erhöhen, um bessere Ergebnisse zu erzielen oder auszuschließen.
