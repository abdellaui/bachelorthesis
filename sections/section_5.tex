...
\citet{acharyaBIMPoseNetIndoorCamera2019} stellten überraschend fest, dass mit zunehmendem \textit{Level of Detail} (LOD) der Gebäudesimulation (\textit{Trainingsdaten}) bei der Evaluation mit den Gradientenbildern der realen Daten zur Abnahme der Akkuratesse führte. Angesichts des höheren LODs des \textit{HS-gamma} Datensatzes liegt die Schlussfolgerung nahe, dass das die schlechte Akkuratesse im 
