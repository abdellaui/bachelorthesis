...
\citet{acharyaBIMPoseNetIndoorCamera2019} stellten überraschend fest, dass die Akuratesse mit einem zunehmendem \textit{Level of Detail} (LOD) der Gebäudesimulation (\textit{Trainingsdaten}) bei der Evaluation mit den Gradientenbildern der realen Daten zu einer Abnahme führte. Die schlechte Generalisierungsfähigkeit des KNNs im \textit{HS-gamma} Datensatz könnte daher auf die hohen LOD des HS Gebäudesimulations zurückgeführt werden. Allerdings liegt angesichts der oben genannten Parallelen die Schlussfolgerung nahe, dass der Ansatz über synthe... begrenzt ist.
