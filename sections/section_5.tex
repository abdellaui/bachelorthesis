...
% Beschränken
Wie oben erwähnt, ist die Akkuratesse vom Zufall abhängig. Daher können weiterführende Forschungen bei gleichen Hyperparametern die Anzahl der Trainingsprozesse erhöhen, um bessere Ergebnisse zu erzielen oder auszuschließen. Dadurch könnte eine Untersuchung der Datentypen stattfinden. Darüber hinaus wurde die Optimierung der Hyperparameter in dieser vorliegenden Arbeit nicht behandelt. Die Optimierung der Hyperparameter kann auf den jeweiligen Datensätzen zu besseren Ergebnissen führen und ist daher eine weitere Empfehlung zu weiterführenden Forschungen. 
