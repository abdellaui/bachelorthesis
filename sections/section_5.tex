...
Die Hyperparameter wurden aus \citet{acharyaBIMPoseNetIndoorCamera2019} übernommen bzw. gleichermaßen bestimmt oder im selben Verhältnis zum Datensatz gewählt. Die Hyperparameter könnten auf die Datensätze von \citet{acharyaBIMPoseNetIndoorCamera2019} besser zusammenpassen als auf die hier erhobenen Datensätzen. Daher könnte bei einer anderen Belegung der Hyperparameter bessere Ergebnisse resultieren.
