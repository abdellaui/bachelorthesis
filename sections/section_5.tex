...
Diese Arbeit behandelt nicht die Optimierung der Hyperparameter. Die Hyperparameter wurden 
Ziel dieser Arbeit ist eine Lokalisierungsgenauigkeit im Meterbereich auf den erhobenen Datensätze anzustreben. Daher ist die Abweichung (\textit{Drift}) bis zu 5\% der realen Evaluationsdaten von den synthetischen Trainingsdaten unproblematisch. Dies hat jedoch zu Folge, das uav etc. In Anbetracht der Ergebnisse ist ein solches nicht denkbar.
