...
Die Ergebnisse von \textit{IC-loop} und \textit{HS-gamma} zeigten Parallele zu den Ergebnissen von \citet{acharyaBIMPoseNetIndoorCamera2019} bzgl. von der Verteilung der Lokalisierungsergebnisse betroffenen Gebäudearealen eine vergleichbare Größe haben und die zu bestimmende Orientierung nur eine Richtung ist bzw. bestimmt wird.
% Eventualitäten
