...
Weiterhin haben die Ergebnisse der Strecken \textit{IC-loop} und \textit{HS-gamma} gezeigt, dass die Evaluationsdaten auf eine ca. 5$m$ hohen und ca. 20$m$ bis 30$m$ langen Teilzone verteilt werden. Außerdem wurden die Orientierung der Evaluationsdaten als die Orientierung der dominierenden Aufnahmerichtung bestimmt. 
