...
Ziel dieser Arbeit ist den Ansatz von \citet{acharyaBIMPoseNetIndoorCamera2019} auf den in dieser Arbeit erhobenen Datensätze zu untersuchen. Dabei wird eine Lokalisierungsgenauigkeit im Meterbereich angestreben. Daher ist die Abweichung (\textit{Drift}) bis zu 5\% der realen Evaluationsdaten von den synthetischen Trainingsdaten unproblematisch. Dies hat jedoch zu Folge, das uav etc. In Anbetracht der Ergebnisse ist ein solches nicht denkbar.
...
Diese Arbeit behandelt nicht die Optimierung der Hyperparameter. Daher wurden die Hyperparameter überwiegen aus \citet{acharyaBIMPoseNetIndoorCamera2019} übernommen. Die Optimierung der Hyperparameter kann auf den jeweiligen Datensätzen zu besseren Ergebnissen führen und ist daher eine weitere Empfehlung für weiterführende Forschungen. 
