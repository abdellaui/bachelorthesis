...
Ziel dieser Arbeit ist nicht eine Lokalisierungsgenauigkeit im Zentimeterbereich anzustreben. Deswegen ist eine 

Daher ist die Abweichung (\textit{Drift}) bis zu 5\% der realen Evaluationsdaten von den synthetischen Trainingsdaten unproblematisch.
