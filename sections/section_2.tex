...
Eine Convolutional Neural Network Architektur setzt sich aus einer Sequenz von unterschiedlichen Schichtarten zusammen \cite{CS231nConvolutionalNeurala}. Im weiteren Verlauf dieses Kapitels werden die Arten der Schichten beschrieben.
  ...
  \begin{table}
	...
	\begin{tabularx}{0.9\textwidth}{X X l}
		\textbf{Art des Schichtes} & \textbf{Parameter} & \textbf{Hyperparameter}\\
		\hline
		Convolutional Layer & Filter & \makecell[tr]{test\\test\\test\\test\\test\\tests}\\
		Pooling Layer &  \textit{keine}  & 33.00 \\
		Fully-Connected Layer & Gewichte & 33.00 \\
		\hline
	\end{tabularx}
