...
Ziel eines KNNs ist es eine Funktion $g^*$ zu approximieren, dass einen Input $x$ auf einen Output $y$ abbildet. Sei $g(x; \theta)=y$  solch eine Funktion, dann versucht ein KNN die Werte des \theta Parameters mit der besten Approximierung zu erlernen.
