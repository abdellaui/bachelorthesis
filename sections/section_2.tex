...
Künstliche Neuronen können zu einer Schicht (layer) zusammengeführt werden. Mehrere solcher Schichten können dann z.B. ein feedforward Netzwerk bilden. Bei einem feedforward Netzwerk übergibt jedes Neuron aus der Schicht $l$ seinen Output an die Neuronen des Schichtes $l+1$ weiter \cite{Goodfellow-et-al-2016}. Die Tiefe (\textit{depth}) eines Netzwerks wird dabei durch die Anzahl der Schichten bestimmt und die Breite (\textit{width}) eines Schichtes wird durch die Anzahl der Neuronen bestimmt.
