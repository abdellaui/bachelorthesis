...
GoogLeNet ist ein 22 Layer tiefes neuronales Netz \footnote{inkl. Output Layer}, bestehend aus 9 Inception Modul (je von Tiefe 2).  Abbildung \ref{fig:googlenet} illustriert die GoogLeNet Architektur in Detail.
