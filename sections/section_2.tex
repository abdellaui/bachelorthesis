...
Sei $x$ das Input, $w$ der Gewichtsvektor, $b$ ein Bias, $f$ eine nicht-lineare Aktivierungsfunktion, dann ist ein künstliches Neuron mit der Inputsgröße $I$ mathematisch folgend formuliert:
\begin{equation}
