...
Sei $x$ das Input, $w$ der Gewichtsvektor, $b$ ein Bias, $\phi$ eine nicht-lineare \textit{Aktivierungsfunktion}, dann ist ein künstliches Neuron mit der Inputsgröße $M$ mathematisch die folgende nicht-lineare Funktion \cite{CS231nConvolutionalNeural}:
\begin{equation}
	\label{eq:neuron}
