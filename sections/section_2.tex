...
Acharya \etal\cite{acharyaBIMPoseNetIndoorCamera2019, acharyaMODELLINGUNCERTAINTYSINGLE2019} erzeugen ebenso Traningsdaten aus einem BIM verwenden jedoch ein Verfahren, welches keine Datenbank benötigt, sondern auf die PoseNet-Architektur aufbaut. Entlang eines Kameraflugbahnes werden unterschiedliche Daten aus dem Simulation eines Korridors gesammelt. Diese Daten unterscheiden sich in der Realitätstreue vom karikaturistisch zu fotorealistisch hin über zu fotorealistisch-texturiert. 
