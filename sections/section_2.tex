...
\begin{figure}[htp]
	...
	\caption{Die ReLU (\textit{rectified liniear unit}) Aktivierungsfunktion wird typischerweise in CNNs eingesetzt und ist mathematisch definiert als: $f(x) = max(0,x)$.}
	\label{fig:relu}
\end{figure}
