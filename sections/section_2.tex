...
Sei $x$ das Input, $w$ der Gewichtsvektor, $b$ ein Bias, $f$ eine nicht-lineare \textit{Aktivierungsfunktion}, dann ist ein künstliches Neuron mit der Inputsgröße $I$ mathematisch die folgende nicht-lineare Funktion \cite{CS231nConvolutionalNeural}:
\begin{equation}
	\label{eq:neuron}
...
Ziel eines KNNs ist es eine Funktion $g^*$ zu approximieren, dass einen Input $x$ auf einen Output $y$ abbildet. Sei $g(x; \theta)=y$  solch eine Funktion, dann lernt ein KNN die Paramtern mit der besten Approxmierung.
