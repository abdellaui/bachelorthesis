...
% hat 2 katogiren..
Die rein visuellen Lokalisierungsmethoden unterteilen sich in indirekte und direkte Methoden. Die indirekten Methoden behandeln das Lokalisierungsproblem als eine Bildersuche in einer Datenbank, ähnlich wie das \textit{Content Based Image Retrieval} \cite{lewContentbasedMultimediaInformation2006} Problem.
\newline
% Arten erläutern
% indirekte methoden
% direkte methoden
