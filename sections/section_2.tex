...
\end{figure}
 ...
 \begin{figure}[H]
	...
	\caption{Der architektonische Aufbau des GoogLeNet Models. Das Inception-Block wird in Abbildung \ref{fig:inception_module} detallierter dargestellt. Diagramm basiert auf \cite{szegedyGoingDeeperConvolutions2015}.}
	\label{fig:googlenet}
\end{figure}
