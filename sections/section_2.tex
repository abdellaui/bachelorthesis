...
\textbf{Simulierte 3D-Daten} werden in der Literatur eingesetzt, um das manuelle Erzeugen und Annotieren von Daten umzugehen. 

 synthesiz- ing images with real-world backgrounds and inserted virtual objects 

Pishchulin \etal\cite{pishchulinArticulatedPeopleDetection2012a} und Peng \etal\cite{pengLearningDeepObject2014} erstellen synthetische Trainingsdaten, indem sie virtuelle Objekte auf reale Hintergründe platzieren. Pishchulin \etal\cite{pishchulinArticulatedPeopleDetection2012a} besitmmt zuvor auf Bildern die körperliche Lage eines Menschen und erzeugen anhand dessen die 3D Modelle der Personen. Anschließend erstellen sie Daten mit simulierten körperlicher Lage der Menschen auf unterschiedlichen Hintergründen. 

Su \etal\cite{suRenderCNNViewpoint2015} 
Dosovitskiy \etal\cite{dosovitskiyFlowNetLearningOptical2015} 
