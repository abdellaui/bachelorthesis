...
\end{equation}
 Bei einem \textit{feedback} Netzwerken, auch bekannt als \textit{Recurrent Neural Networks}, können Neuronen mit Neuronen aus jedem Schicht, sowie zu sich selbst, verbunden sein. Im weiteren Verlauf dieser Arbeit ist bei einem Netzwerk immer ein feedforward Ansatz gemeint, da feedback Netzwerke keinen Bestand in dieser Arbeit haben.
