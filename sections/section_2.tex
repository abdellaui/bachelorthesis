...
% - rgb-d
% - image only
\textbf{Pose Estimation} im Hinblick auf die visuelle Lokalisierung \textit{(Visual-Based Localization, kurz VBL)} beschäftigt sich mit der Bestimmung der Pose (Position + Orientierung) eines visuellen Abfragematerials (z.B. Bild) in einer zuvor bekannten Szene  \cite{piascoSurveyVisualBasedLocalization2018}..
Ei
