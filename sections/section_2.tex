...
Einen Fortschritt erhalten die Autoren von PoseNet durch die Anpassung ihres Models an einem Bayessian Neural Network \cite{denkerTransformingNeuralNetOutput1991, mackayPracticalBayesianFramework1991} an \cite{kendallModellingUncertaintyDeep2015a}.
