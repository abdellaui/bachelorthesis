...
Ziel eines KNNs ist es eine Funktion $g^*$ zu approximieren, dass einen Input $x$ auf einen Output $y$ abbildet. Ein feedforward neuronales Netz approximiert die Funktion $g(x; \theta)=y$  mit den bestmöglichen Paramtern für  $\theta$.
 Netz lernt durch die Anpassung der Gewichte.
