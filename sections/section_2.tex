...
\label{sec:googlenet}
GoogLeNet, konstruiert von \citet{szegedyGoingDeeperConvolutions2015} im Jahr 2014, ist der Sieger des ILSVRC14 Wettbewerbes. Das Netzwerk zeichnet sich mit einer raffinierten Architektur aus, die bei der Zunahme der Tiefe und Breite eines Netzwerkes konstante Re  Das GoogLeNet ist ein 22 Layer tiefes Netzwerk, bestehend aus 9 sogenannten Inception Modulen. Ein Inception Modul beinhaltet 
