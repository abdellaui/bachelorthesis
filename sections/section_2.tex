...
Es gibt zahlreiche bekannte CNN Modelle. Grundsätzlich erzielen diese Modelle in internationalen Wettbewerben, solche wie die ILSVRC \cite{russakovskyImageNetLargeScale2014}, ausgezeichnete Ergebnisse. Dieses Kapitel behandelt nur die Architektur des GoogLeNet Models und dessen Modifaktion PoseNet.

\subsubsection{GoogLeNet}
\label{sec:googlenet}
Das GoogLeNet Model, konstruiert von \citet{szegedyGoingDeeperConvolutions2015} im Jahr 2014, ist der Sieger des ILSVRC14 Wettbewerbes. In dem selben Paper stellen die Autoren das \textit{Inception Modul} dar.
