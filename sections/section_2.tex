...
% Posenet erklären
PoseNet ist die Feinabstimmung des GoogLeNet \cite{szegedyGoingDeeperConvolutions2015} DCNNs und zweckentfremder es von der Bildklassifizierung zu einem Lokalisierungs-Regressor. Trainiert mit einem Datensatz bestehend aus Paaren von Farbbild und Pose, kann es die sechs Freiheitsgrade der Kamerapose bestimmen.
% Varianten aufzählen
