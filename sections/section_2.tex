...
Abbildung \ref{fig:googlenet} illustriert die GoogLeNet Architektur in Detail.
 ...
 \begin{figure}[H]
	...
	\caption{Inception module. Die Ergebnisse der unabhängigen Convolution-Operationen haben die gleiche Breite und Höhe. Der Output des Inception Moduls wird durch das Konkatenieren (in der Tiefe) der einzelnen Ergebnisse bestimmt. Entnommen aus \cite{szegedyGoingDeeperConvolutions2015}.}
