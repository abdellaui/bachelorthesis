...
Sei $x$ das Input, $w$ der Gewichtsvektor, $b$ ein Bias, $f$ eine nicht-lineare Aktivierungsfunktion, dann ist ein künstliches Neuron mit der Inputsgröße $i \in I$ mathematisch folgend formuliert:
\begin{equation}
	o_{j}=H\left(\sum_i w_{ij} x_{i} - b\right)
\end{equation}
