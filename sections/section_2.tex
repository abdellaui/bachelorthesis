...
% - rgb-d
% - image only
 \cite{piascoSurveyVisualBasedLocalization2018}.
\textbf{Pose Estimation} ist eine Methode der visuellen Lokalisierung \textit{(Visual-Based Localization, kurz VBL)}. VBL beschäftigt sich mit der Bestimmung der Pose (Position + Orientierung) eines visuellen Abfragematerials (z.B. Bild) in einer zuvor bekannten Szene.
bla bla bla
