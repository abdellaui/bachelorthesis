...
Acharya \etal\cite{acharyaBIMPoseNetIndoorCamera2019, acharyaMODELLINGUNCERTAINTYSINGLE2019} erzeugen ebenso Trainingsdaten aus einem BIM, verwenden jedoch kein Datenbank bedürftiges Verfahren zur Lokalisierung, sondern bestimmen die Pose direkt über PoseNet. Hierbei werden entlang eines Kameraflugbahnes werden unterschiedliche Daten aus dem Simulation eines Korridors gesammelt. Diese Daten unterscheiden sich in der Realitätstreue vom karikaturistisch zu fotorealistisch hin über zu fotorealistisch-texturiert. 

Die besten Ergebnisse konnten die Autoren trainiert mit den Gradienten- und Kantenbilder der karikaturistischen Daten getestet auf die Gradientenbilder der realen Aufnahmen erzielen.
