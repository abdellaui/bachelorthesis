...
% - rgb-d
% - image only
\textbf{Pose Estimation} ist eine Methode der visuellen Lokalisierung \textit{(Visual-Based Localization, kurz VBL)}. VBL beschäftigt sich mit der Bestimmung der Pose (Position + Orientierung) eines visuellen Abfragematerials (z.B. ein Bild) in einer zuvor bekannten Szene  \cite{piascoSurveyVisualBasedLocalization2018}.
