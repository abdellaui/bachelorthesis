...
\begin{enumerate*}[label=(\arabic*)]
	...
	\item Pose Regression mit Tiefenbilder, in der Literatur auch RGB-D Bilder genannt.
	\item Pose Regression nur mit Bildern.
\end{enumerate*}

Diese Ansätze haben starke Ähnlichkeiten zur den indirekten Methoden und benötigen eine 3D-punktwolken Repräsentation der Szene.


Diese Forschungsprojekte liefern gewünschte Resultate, jedoch benötigen diese Ansätze die nicht so weit verbreiteten 3D-Kameras.
% Arten erläutern
% indirekte methoden
% direkte methoden
% - point-matching
