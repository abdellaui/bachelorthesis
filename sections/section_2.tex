...
Inspiriert von ihren biologischen Vorbildern \footnote{das Nervensystem eines Lebewesen, z.B. des Menschen}, vernetzen \textit{Artificial Neural Networks}, auf Deutsch künstliche neuronale Netzwerke (KNN), künstliche Neuronen miteinander.
...
Künstliche Neuronen können zu einer Schicht (layer) zusammengeführt werden. Mehrere solcher Schichten können dann z.B. ein feedforward Netzwerk bilden. Bei einem feedforward Netzwerk übergibt jedes Neuron aus der Schicht $l$ seinen Output an die Neuronen des Schichtes $l+1$ weiter \cite{Goodfellow-et-al-2016}. 
