...
Getrieben vom Einsatz von simulierten 3D-Daten zur Datengenerierung stellt Ha \etal einen Ansatz zur Bild-basierte Lokalisierung in Gebäuden vor. Dieser Ansatz generiert synthetische Daten aus einem Building Information Modeling (BIM) und vergleicht diese mit realen Aufnahmebildern. Beim Vergleich werden die Ausgabewerte eines CNNs berücksichtigt.
