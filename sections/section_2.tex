...
Im weiteren Fortgang des Kapitels werden einige grundlegende Themen erläutert. Zuerst wird die Lineare Faltung erklärt und . Danach wird ein vertieftes Wissen an CNN vermittelt und anschließend bekannte CNN Modelle näher erläutert.

\subsection{Lineare Faltung}
\subsubsection{Sobelfilter}
\subsubsection{Gradientenbilder}
