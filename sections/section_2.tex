...
Fanello \etal\cite{fanelloLearningBeDepth2014} rendert künstliche Infrarotbilder von Händen und Gesichtern zwecks Tiefenerkennung aus einem RGB-Bild.
Dosovitskiy \etal\cite{dosovitskiyFlowNetLearningOptical2015} erlernen mit synthetischen Daten den optischen Fluss von Bildsequenzen. Auf Hintergrundbildern aus einer Sammlung werden mehrmals bewegte 3D simulierte Stühle platziert.
