...
Inspiriert von ihren biologischen Vorbildern, vernetzen \textit{Artificial Neural Networks}, auf Deutsch künstliche neuronale Netzwerke (KNN), künstliche Neuronen miteinander.

Ein einzelnes Neuron erhält einen Inputsignal auf mehreren Kanälen und löst erst ein Signal \textit{(output}) aus, falls die gewichtete Summe des Inputs einen gewissen Schwellwert erreicht.

Künstliche Neuronen können zu einem Schicht (layer) zusammengeführt werden. Mehrere solcher Schichten können dann z.B. ein feedforward Netzwerk bilden. Bei einem feedforward Netzwerk übergibt jedes Neuron aus der Schicht $l$ seinen Output an die Neuronen des Schichtes $l+1$ weiter. 

KNN vernetzen sehr viele künstlich Neuronen.
