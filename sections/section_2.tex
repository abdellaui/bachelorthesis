...
Ziel eines KNNs ist es eine Funktion $g^*$ zu approximieren, dass einen Input $x$ auf einen Output $y$ abbildet. Bei einem feedforward neuronales Netz $g(x;\theta)=y$ ist dabei die Verkettung der 
