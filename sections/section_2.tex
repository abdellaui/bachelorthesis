...
\textbf{Pose Estimation} ist eine Methode der visuellen Lokalisierung, engl. Visual-Based Localization(VBL). VBL beschäftigt sich mit der Bestimmung der Pose (Position + Orientierung) eines visuellen Abfragematerials (z.B. Bild) in einer zuvor bekannten Szene.
bla bla bla
