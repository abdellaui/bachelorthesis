...
In dieser Arbeit wurden aus zwei unterschiedlichen Gebäuden Daten erhoben bzw. synthetische Daten aus den Gebäudesimulationen generiert.  Die Gebäude unterscheiden sich im Detail der Simulationen (vgl.  Abb. \ref{fig:difference_3d}). Die Simulation vom IC enthält wiederholende Gebäudemerkmale sowie sehr wenige Objekte wie z.B. Türen und Wände. Deshalb wurde im IC nur ein Datensatz entlang einer geschlossene Schleife erhoben. Im Gegensatz dazu enthält die Simulation vom HS eindeutige Gebäudemerkmale wie z.B. das Treppenhaus sowie mehr Objekte wie z.B. die Objekte der technischen Gebäudeausrüstung. Daher wurden mehrere Datensätze im HS erhoben, die einerseits sich über mehrere Etagenebenen im Treppenhauses erstrecken und anderseits auf einer Strecke in mehreren Richtungen verlaufen.
