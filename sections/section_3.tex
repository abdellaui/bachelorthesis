...
\begin{figure}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{karikaturistische Simulation \hspace{1cm} (\textit{cartoon})}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{synthetisches \hspace{1cm} Kantenbild \hspace{1cm} (\textit{edge})}
		\label{subfig:edge}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{fotorealistische \hspace{1cm} Simulation \hspace{1cm} (\textit{photoreal})}
