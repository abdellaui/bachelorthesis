...
Aus Zeitgründen konnten die Bestkonditionen für die T265 nicht verschafft werden, sodass die von der T265 berechneten Posen eine Abweichung (\textit{Drift}) bis zur augenscheinlich 5\% (vgl. Abbildung \ref{fig:trajectories}).
\begin{figure}
	\centering
