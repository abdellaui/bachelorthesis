...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{l l l l l l}
		\textbf{Bezeichnung} & \textbf{Typ} & \makecell[tl]{\textbf{Anzahl Daten}  \\ (davon verwendet)} & \textbf{Streckenlänge} & \textbf{Fläche der Aufnahmezone} & Gebäude\\
		\hline
		IC-6 & real & 3874 (3000)& 115$m$ & $30m \times 30m$\\
		\hline
		IC-6 & synthetisch & 11000 (11000)& 115$m$ & $30m \times 30m$\\
	\end{tabularx}
