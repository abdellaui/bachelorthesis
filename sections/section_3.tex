...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Datensatz pro Frame. \ref{subfig:odom1}  und \ref{subfig:odom2} visualisieren die von der T265 ermittelte Odometrie und die von der D435 erhaltene 3D Punktwolke in unterschiedlichen Prespektive. \ref{subfig:fisheye1} und \ref{subfig:fisheye2} sind die von der T265 aufgenommenen Fischaugenbilder.}
	\label{fig:dataset}
\end{figure}
