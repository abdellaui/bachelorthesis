...
Die Gewichte des Netzwerks werden mit den Gewichten eines Models, das auf der GoogLeNet Architektur mit dem Places Datensatz \cite{zhouLearningDeepFeatures2014} trainiert wurde, initialisiert. Anschließend wird mit den synthetischen Daten trainiert und mit den realen Daten getestet.
