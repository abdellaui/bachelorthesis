...
Im weiteren Verlauf dieses Kapitel werden die verwendeten Datensätze gelistet, die Erhebung / Generierung der realen / synthetischen Daten beschrieben, die Verarbeitung der Daten dargestellt und die Trainingsparameter angegeben. 
...
Zuerst wird ein Datensatz aus der a) der nördliche Hälfte des 6. Stockwerkes der IC-Gebäude Ruhr-Universität Bochum erhoben. Anschließend werden drei Datensätzen im b) Seminargebäude Hochschule Bochum erhoben. Alle Datensätze beinhalten schwierige Herausforderung. Die Strecke im ersten Datensatz, bezeichnet als \textit{IC-Loop}, bildet eine geschlossene Schleife. Im Datensatz \textit{HS-stairs-up} wird eine Treppe aufwärts bestiegen und im Datensatz \textit{HS-stairs-down} dieselbe Treppe abgestiegen. Die Strecke im \textit{HS-gamma} einhält in der Mitte eine Schleife, anfangs und Endpunkte sind in optisch ähnlichen gegenüberliegenden Punkten
...
Die Gebäude werden in Blender\footnote{\url{https://www.blender.org/about/} (aufgerufen am: 20.07.2019)} Version 2.79b simuliert. Die intrinsischen Daten der D435 RGB-Kamera werden auf die virtuellen Kameras übertragen und die Auflösung wird aus Zeitgründen halbiert auf  $960\times540$.
...
Bei der Erzeugung von Gradientenbilder gehen einerseits wichtige Informationen im Hinblick auf das Ursprungsbild verloren, andererseits bleiben wichtige Informationen wie z.B. die geometrische Struktur erhalten. Die Fortbewegung entlang der Strecke bei den realen Aufnahmen führt zu unscharfen Bildern, die die Sichtbarkeit der geometrische Struktur erschweren. Daher werden die realen Bilder vor der Verarbeitung in Gradientenbilder auf die Größe $960 \times 540$ von den synthetischen Bildern verkleinert.
