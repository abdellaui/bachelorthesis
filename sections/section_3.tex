...
Zuerst wird ein Datensatz aus der a) nördlichen Hälfte des 6. Stockwerkes des IC-Gebäudes Ruhr-Universität Bochum erhoben. Anschließend werden drei Datensätzen im b) Seminargebäude Hochschule Bochum erhoben. Die Gebäude unterscheiden sich im Detail der Simulationen. Die Simulation von der Gebäude a) enthält sehr wenige Objekte wie  z.B. Türen und Wände. Im Gegensatz dazu enthält die Gebäudesimulation b) mehr Objekte wie z.B. die Objekte der technischen Gebäudeausrüstung.
...
Die Anzahl der Daten werden auf die Tausenderstelle abgerundet und diese Anzahl an zufälligen Daten aus dem Datensatz verwendet (vgl. Tabelle \ref{tab:datasets} ).
