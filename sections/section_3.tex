...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{l l l p{1.7cm} p{2.1cm} l}
		\textbf{Bezeichnung} & \textbf{Typ} & \makecell[tl]{\textbf{Anzahl Daten}  \\ (davon verwendet)} & \textbf{Strecken\-länge} & \textbf{Fläche Auf\-nahme\-zone} & \textbf{Gebäude}\\
		\hline
