...
Es wird die PoseNet Implementierung in Caffe \cite{jiaCaffeConvolutionalArchitecture2014} von den Autoren \citet{kendallPoseNetConvolutionalNetwork2015} verwendet. 
