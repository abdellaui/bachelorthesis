...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Datensatz pro Frame. \ref{subfig:odom1}  und \ref{subfig:odom2} visualisieren die von der T265 ermittelte Odometrie und die von der D435 erhaltenen 3D Punktwolke in unterschiedlichen Prespektive. \ref{subfig:fisheye1} und \ref{subfig:fisheye2} sind die von der T265 aufgenommenen Fischaugenbilder. \ref{subfig:rgb-image} ist das RGB-Bild, die durch die D435 ausgezeichnet wurde, und \ref{subfig:depth-image} das dazugehörige Tiefenbild. }
	\label{fig:dataset}
\end{figure}
