...
Die Ergebnissen der Experimente von \citet{acharyaBIMPoseNetIndoorCamera2019}, die das PoseNet Model mit Gradienten- und Kantenbilder der karikaturistischen Bilder trainieren und anschließen mit den Gradientenbilder der realen Bilder evaluieren, konnten näherungsweise reproduzieren.
In dieser Arbeit wurden zwei 3D-Modelle von unterschiedlichen Gebäuden verwendet. 
