...
Alle Datensätze beinhalten schwierige Herausforderung wie z.B. das Loop-Closure- oder Perceptual-Aliasing-Problem. Die ca. $115m$ lange Strecke im ersten Datensatz, bezeichnet als \textit{IC-Loop}, bildet eine geschlossene Schleife in einer $50m \times 11m \times 3.5m$ Teilzone der Gebäude a). Im Datensatz \textit{HS-stairs-up} wird eine Treppe der Gebäude b) aufwärts bestiegen und im Datensatz \textit{HS-stairs-down} dieselbe Treppe abgestiegen. Die Strecke auf den Treppen beträgt ca $32m$ und befindet sich in einer $xyZ$ Teilzone cer Gebädue b). Die $xm$ Strecke im \textit{HS-gamma} Datensatz einhält in der Mitte eine Schleife. Der Anfangs- und Endpunkte der Strecke im HS-gamma Datensatz sind in optisch ähnlichen gegenüberliegenden Punkten der Gebäude b) in einem Bereich von $xyz$. Abbildung x illustriert die Strecken der Datensätze. Die Namensgebung der Datensätze ist in Anbetracht der Abbildung x selbsterklärend. 
