...
Die Ergebnissen der Experimente von \citet{acharyaBIMPoseNetIndoorCamera2019}, die das PoseNet Model mit Gradientenbilder der karikaturistischen Daten sowie synthetischen Kantenbilder trainieren und anschließend mit den Gradientenbilder der realen Daten evaluieren, konnten näherungsweise reproduziert werden. 


\begin{table}[H]
	\centering
	\caption{Reproduktionsergebnisse. Abweichungen sind durch Zufall bedingt und könnten bei mehrfachem Wiederholen des zeitintensiven Trainingsprozesses minimiert bzw. erhoben werden }
	\begin{tabularx}{1.0\textwidth}{X X X}
		 \textbf{Trainingsdatensatz} & \textbf{Trainingsdatensatz} \hspace{2cm} (Gradientenbild)& \textbf{Akkuratesse} \hspace{2cm} (Position, Orientierung)\\
		\hline
		BIM-PoseNet & karikaturische Simulation & 2.63$m$, 6.99°\\
		\hline
		BIM-PoseNet & Kantenbild & 1.88$m$, 7.73°\\
		\hline
		Reproduktion & karikaturisch Simulation & 2.74$m$, 12.24°\\
		\hline
