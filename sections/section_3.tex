...
Die Abbildung \ref{fig:trajectories} illustriert die Strecken der Datensätze. Die Tabelle \ref{tab:datasets} stellt die Anzahl der Daten in den Datensätzen dar.
