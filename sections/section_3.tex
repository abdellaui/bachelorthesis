...
Die Strecken der echten Aufnahmen wurden in den Simulationen Konsistenz halber auf einer konstanten Höhe von 1.70$m$ soweit wie möglich imitiert. Eine exakte Imitation der Aufnahmestrecke der echten Daten war wegen des Abdriften der, von der T265 berechneten, Pose nicht möglich (siehe Abbildung \ref{fig:trajectories}).
