...
Die vorliegende Arbeit verwendet die in Abschnitt \ref{sec:posenet} beschriebene PoseNet Architektur. Für diese Arbeit wurde die Caffe \cite{jiaCaffeConvolutionalArchitecture2014} Implementierung von den PoseNet Authoren \citet{kendallPoseNetConvolutionalNetwork2015} verwendet. Die Gewichte des Netzwerks wurde mit den Gewichten eines Models, das auf der GoogLeNet Architektur mit dem Places Datensatz \cite{zhouLearningDeepFeatures2014} trainiert wurde,  initialisiert. 
