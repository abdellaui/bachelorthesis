...
Im weiteren Verlauf dieses Kapitel werden die Datensätze aufgelistet. Danach wird die Erhebung / Generierung der realen / synthetischen Daten beschrieben und die Verarbeitung der Daten dargestellt. Im Anschluss wird die Trainingsparameter angegeben.
...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{X X X >{\centering\arraybackslash}p{1.7cm} }
		...
		\hline
		HS-stairs-up & $32m$ & $12m \times 12m \times 12m$ & a)\\
		\hline
		HS-stairs-down & $32m$ & $12m \times 12m \times 12m$ & a)\\
		\hline
		HS-loop & $65m$ & $54m \times 10m \times 3m$ & a)\\
	\end{tabularx}
