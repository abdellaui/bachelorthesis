...
Für die Erzeugung der synthetischen Kantenbilder wurden die Kanten der 3D-Objekte über Blender markant sichtbar konfiguriert und eine homogene Beleuchtung verschaffen, damit die Kanten unberührt von Beleuchtungseffekte bleiben (vgl. Abbildung \ref{fig:dataset}). Der karikaturistische Datensatz sowie die Kantenbilder wurden über die Render-Engine \textit{Blender Render} und der fotorealistischer Datensatz wurde über die \textit{Cycles-Engine} generiert. Die karikaturistische und fotorealistische Datensätze unterscheiden sich ausschließlich in den Render-Engines.
