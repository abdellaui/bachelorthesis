...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.3\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/synth/b00643.png}
		\caption{Cartoonish}
	...
	\begin{subfigure}[b]{0.3\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/synth/e00643.png}
		\caption{Edge}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.3\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/synth/c00643.png}
		\caption{Photorealistic}
	\end{subfigure}
	\medskip
	\begin{subfigure}[b]{0.3\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/synth/bg00643.png}
		\caption{Gradientenbild von\ref{subfig:cartoonish}}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.3\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/synth/eg00643.png}
		\caption{RGB-Bild \\ (D435) \hspace*{2cm}}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.3\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/synth/cg00643.png}
		\caption{Tiefenbild \\ (D435) \hspace*{2cm}}
	\end{subfigure}
	\caption{Ein Auszug}
	\label{fig:dataset}
