...
\begin{figure}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{karikaturistische Simulation (\textit{cartoon})}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{synthetisches \hspace{1cm} Kantenbild \textit{edge}}
		\label{subfig:edge}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{fotorealistische \hspace{1cm} Simulation (\textit{photoreal})}
