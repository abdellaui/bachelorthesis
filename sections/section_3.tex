...
\begin{table}
	...
	\begin{tabularx}{1.0\textwidth}{p{3.5cm} p{1.8cm} X  >{\centering\arraybackslash}p{1.7cm} }
		\textbf{Bezeichnung} & \textbf{Typ} & \textbf{Anzahl realer Daten (syn.)} & \textbf{Gebäude}\\
		\hline
		IC-loop & real & 3842 (11435) & IC\\
		\hline
		HS-gamma & real & 1958 (6490) & HS\\
		\hline
		HS-stairs-up & real & 1068 (3160)& HS\\
		\hline
		HS-stairs-down & real & 1161 (3245) & HS\\
	\end{tabularx}
	\label{tab:datasets}
\end{table}
