...
Die Variation der Streckenlänge führt logischweiße in den Datensätzen zu unterschiedlicher Anzahl an realen sowie synthetischen Daten. Tabelle \ref{tab:datasets} stellt die Anzahl der Daten in den Datensätzen dar.
