...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{X X X >{\centering\arraybackslash}p{2cm} }
...
\begin{table}[H]
	\centering
	\caption{Übersicht der Datensätze.}
	\begin{tabularx}{1.0\textwidth}{X p{1cm} X X >{\centering\arraybackslash}p{2cm} }
		\textbf{Bezeichnung} & \textbf{Typ} & \textbf{Anzahl Daten} & \textbf{Verwendete Daten} & \textbf{Gebäude}\\
		\hline
