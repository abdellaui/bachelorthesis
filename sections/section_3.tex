...
Tabelle \ref{tab:dataset_metrics} listet die approximierten metrischen Eigenschaften der Datensätze auf. Abbildung \ref{fig:trajectories} illustriert die Strecken der Datensätze. Tabelle \ref{tab:datasets} stellt die Anzahl der Daten in den Datensätzen dar.
...
Es wird zusätzlich ein Schwellenwertverfahren mit einer Schwelle von 64 angewendet, um unerwünschter Artefakte zu unterdrücken, sodass alle Pixeln im Wertebereich $[64, 255]$ liegen. Abbildung \ref{fig:dataset_preprocess} visualisiert von jedem Datensatztyp ein Beispiel und die dazugehörigen Gradientenbilder.
...
\node [image node] { 			   \includegraphics[width=0.4\textwidth]{images/treshold/0_treshold.png} 
};
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/treshold/base.png}
		\caption{Ausgangsbild}
		\label{subfig:tresh_1}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.24\linewidth}
		\centering
		...
		connect zoomboxes,
		zoombox paths/.append style={ultra thick, red}]
		\node [image node] { 			   \includegraphics[width=\textwidth]{images/treshold/0_treshold.png} 
		};
		\zoombox[magnification=2]{0.175,0.72}
		\zoombox[magnification=2]{0.71,0.5}
		\zoombox[magnification=10]{0.86,0.38}
		...
		%\includegraphics[width=\linewidth]{images/treshold/0_treshold.png}
		\caption{Gradientenbild \hspace{3cm}  + Schwelle von 0}
		\label{subfig:tresh_2}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/treshold/32_treshold.png}
		\caption{Gradientenbild \hspace{3cm}  + Schwelle von 32}
		\label{subfig:tresh_3}
	\end{subfigure}
	\hfill 
	\begin{subfigure}[t]{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/treshold/64_treshold.png}
		\caption{Gradientenbild \hspace{3cm} + Schwelle von 64}
		\label{subfig:tresh_4}
	\end{subfigure}
	\hfill
