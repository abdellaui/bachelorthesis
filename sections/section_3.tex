...
\begin{table}[bp]
	...
	\begin{tabularx}{1.0\textwidth}{X X}
		...
		\hline
		Loss-Optimierer & \textit{AdaGrad} \cite{duchiAdaptiveSubgradientMethods2011}\\
		\hline
		Lernrate & $10^{-3}$\\
		\hline
