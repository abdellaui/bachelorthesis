...
\begin{figure}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{\RaggedRight karikaturistische Simulation \hspace{1cm} (\textit{cartoon})}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{\RaggedRight synthetisches \hspace{1cm} Kantenbild \hspace{1cm} (\textit{edge})}
		\label{subfig:edge}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{\RaggedRight fotorealistische \hspace{1cm} Simulation \hspace{1cm} (\textit{photoreal})}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{reale Aufnahme \hspace{2cm} (\textit{real})}
		\label{subfig:real}
	\end{subfigure}
	\hfill 
	\begin{subfigure}[t]{0.24\linewidth}
