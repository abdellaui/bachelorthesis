...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{X X X}
		\textbf{Bezeichnung} & \textbf{Strecken\-länge} & \textbf{Volumen der Aufnahmezone} & \textbf{Gebäude}\\
		\hline
		IC-6-loop & 115$m$ & $50m \times 11m \times 3.5m$ & a) \\
		\hline
		IC-6-loop-syn & 115$m$ & $30m \times 30m$ & a)\\
	\end{tabularx}
...
\begin{table}[H]
	\centering
	\caption{Übersicht der Datensätze.}
	\begin{tabularx}{1.0\textwidth}{l l l p{1.7cm} p{3.5cm} c}
		\textbf{Bezeichnung} & \textbf{Typ} & \makecell[tl]{\textbf{Anzahl Daten}  \\ (davon verwendet)} & \textbf{Strecken\-länge} & \textbf{Volumen Auf\-nahmezone} & \textbf{Gebäude}\\
		\hline
		IC-6-loop & real & 3842 (3000)& 115$m$ & $50m \times 11m \times 3.5m$ & a) \\
		\hline
		IC-6-loop-syn & synth. & 11435 (11000)& 115$m$ & $30m \times 30m$ & a)\\
		\hline
		HS-stairs & real & 11000 (11000)& 115$m$ & $30m \times 30m$ & b)\\
		\hline
		HS-stairs-syn & synth. & 11000 (11000)& 115$m$ & $30m \times 30m$ & b)\\
		\hline
		HS-floor & real & 11000 (11000)& 115$m$ & $30m \times 30m$ & b)\\
		\hline
		HS-floor-syn & synth. & 11000 (11000)& 115$m$ & $30m \times 30m$ & b)\\
	\end{tabularx}
	\label{tab:datasets}
\end{table}
