...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{Gradient \vspace*{3cm}  + Schwelle von 0}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{Gradient \vspace*{3cm}  + Schwelle von 32}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{Gradient \vspace*{3cm} + Schwelle von 64}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{reale Aufnahme \vspace*{2cm}}
		\label{subfig:real}
	\end{subfigure}
	\hfill 
	\begin{subfigure}[t]{0.24\linewidth}
