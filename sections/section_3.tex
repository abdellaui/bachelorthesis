...
\begin{figure}[htp]
	...
	\end{subfigure}
	\hfill
	\caption{Illustration der Aufnahmestrecken pro Datensatz. \ref{subfig:traj_ic} befindet sich in der nördlichen Hälfte des 6. Stockwerkes des IC-Gebäudes Ruhr-Universität Bochum. \ref{subfig:traj_hs_gamma}, \ref{subfig:traj_hs-up}, \ref{subfig:traj_hs-down} befinden sich im Seminargebäude Hochschule Bochum. \ref{subfig:traj_hs-up} und \ref{subfig:traj_hs-down} sind nahe an der Positionder Schleife von \ref{subfig:traj_hs_gamma}. Die Tabelle \ref{tab:dataset_metrics} listet die approximierten metrischen Eigenschaften der Aufnahmenstrecken auf.}
