...
Bei der Erzeugung des \textit{Edge}-Datensatzes wurde eine konstante Beleuchtung verschaffen und die Kanten über Blender markant sichtbar konfiguriert. Bei Cartoonish und Edge wurde die Render-Engine \textit{Blender Render} und bei Photorealistic die Render-Engine \textit{Cycles} verwendet.
