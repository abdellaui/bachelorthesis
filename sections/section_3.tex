...
Künstliche neuronale Netze bzw. CNNs werden zuerst modelliert und anschließend mit entsprechenden Daten trainiert. Die vorliegende Arbeit verwendet die Caffe \cite{jiaCaffeConvolutionalArchitecture2014} Implementierung der PoseNet Architektur, die in Abschnitt \ref{sec:posene} beschrieben wird. 
