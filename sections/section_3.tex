...
\begin{figure}[H]
	...
	\zoombox[magnification=10]{0.5,0.25}
	\end{tikzpicture}
	\caption{Darstellung der durch die künstliche Beleuchtung entstehenden Artefakte in den Gradientenbilder. \subref{gradma-image} ist ein Gradientenbild ohne Anwendung eines Schwellenwertverfahrens. Für eine bessere Visualisierung der Artefakte wird in \subref{tbinared-image} das Gradientenbild \subref{gradma-image}  binarisiert. }
	\label{fig:treshold}
\end{figure}
