...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{l l l p{1.7cm}l p{1.0cm}l l}
		\textbf{Bezeichnung} & \textbf{Typ} & \makecell[tl]{\textbf{Anzahl Daten}  \\ (davon verwendet)} & \textbf{Strecken\-länge} & \textbf{Fläche der Aufnahmezone} & \textbf{Gebäude}\\
		\hline
		IC-6 & real & 3874 (3000)& 115$m$ & $30m \times 30m$ & a) \\
		\hline
		IC-6 & synthetisch & 11000 (11000)& 115$m$ & $30m \times 30m$ & a)\\
	\end{tabularx}
