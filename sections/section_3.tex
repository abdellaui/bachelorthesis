...
\begin{figure}
	...
	figurename=gradma]
	\node [image node] { \includegraphics[width=0.3\textwidth]{images/treshold/0_tresh.png} };
	...
	zoombox paths/.append style={thick, orange},
	figurename=tbinared]
	\node [image node] { \includegraphics[width=0.3\textwidth]{images/treshold/0_tresh_binared.png} };
	\zoombox[magnification=10]{0.15,0.8}
	\zoombox[magnification=10]{0.5,0.25}
	\end{tikzpicture}
