...
Diese Arbeit folgt den Ansatz von \citet{acharyaBIMPoseNetIndoorCamera2019} mit Gradienten- bzw Kantenbilder der synthetischen Daten das Netzwerk zu trainieren, um anschließend mit Gradientenbilder der realen Daten das Netzwerk zu evaluieren. Im weiteren Verlauf dieses Kapitel wird die Erhebung bzw. Generierung der entsprechenden Daten erläutert.
...
\subsection{Verwendetete Datensätze}
