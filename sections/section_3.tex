...
\citet{acharyaBIMPoseNetIndoorCamera2019} haben Daten entlang einer ca. 30$m$ langen Strecke in der 3D-Simulation eines ca. 43$m^2$ Korridors gesammelt. Anschließend wurde das PoseNet Modell (siehe Abschnitt \ref{sec:posenet}) mit Gradienten- bzw. Kantenbilder der synthetischen Daten trainiert und mit Gradientenbilder der realen Daten evaluiert. Dabei erhielten die Autoren  eine Akkuratesse von ca. $2m$ in der Position und 7° in der Orientierung.
