...
Künstliche neuronale Netze bzw. CNNs werden zuerst modelliert und anschließend mit entsprechenden Daten trainiert. Die vorliegende Arbeit verwendet die Caffe \cite{jiaCaffeConvolutionalArchitecture2014} Implementierung der PoseNet Architektur, die in Abschnitt \ref{sec:posenet} beschrieben wird. Das Netzwerk wird mit den Gewichten eines auf der GoogLeNet Architektur mit dem Places Datensatz \cite{zhouLearningDeepFeatures2014}  vortrainiertes Models vorinitialisiert
