...
\begin{figure}[htp]
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{fotorealistische \vspace*{1em} Simulation}
	...
	\begin{subfigure}[t]{0.24\linewidth}
		...
		\caption{Gradientenbild  \vspace*{1em} von \ref{subfig:cartoonish}}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/example/eg00643.png}
		\caption{Gradientenbild  \vspace*{1em} von \ref{subfig:edge}}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/example/cg00643.png}
		\caption{Gradientenbild  \vspace*{1em} von \ref{subfig:photorealistic}}
	\end{subfigure}
	\begin{subfigure}[t]{0.24\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/example/rg000305.png}
		\caption{Gradientenbild  \vspace*{1em} von \ref{subfig:real}}
	\end{subfigure}
	\hfill
