...
Für die Erzeugung des \textit{Edge}-Datensatzes wurde eine konstante Beleuchtung verschaffen und die Kanten über Blender markant sichtbar konfiguriert. Die Datensätze Cartoonish und Edge wurde über die Render-Engine \textit{Blender Render} und der Datensatz Photorealistic über die Render-Engine \textit{Cycles} generiert.
