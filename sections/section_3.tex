...
Die vorliegende Arbeit verwendet das in Abschnitt \ref{sec:posenet} beschriebene PoseNet Model. Das PoseNet Model ist von den Autoren \citet{kendallPoseNetConvolutionalNetwork2015} in Caffe \cite{jiaCaffeConvolutionalArchitecture2014} implementiert. 

Die Gewichte des Netzwerks werden mit den Gewichten eines Models, das auf der GoogLeNet Architektur mit dem Places Datensatz \cite{zhouLearningDeepFeatures2014} trainiert wurde, initialisiert. Anschließend wird mit den synthetischen Daten trainiert und mit den realen Daten getested.
