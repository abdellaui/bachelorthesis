...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{X X}
		...
		\hline
		$\beta$ der Kostenfunktion (vgl. Gleichung \ref{eq:posenet_loss}) & $160$\\
		\hline
		...
		\hline
		Initialisierung der Gewichte & Gewichte eines trainierten Models mit Places Datensatz auf der GoogLeNet Architektur \\
	\end{tabularx}
