...
\begin{figure}[H]
	...
	zoomboxarray rows=1,
	figurename=gradma]
	\node [image node] { \includegraphics[width=0.45\textwidth]{images/treshold/0_tresh.png} };
	...
	zoomboxarray rows=1,
	figurename=tbinared]
	\node [image node] { \includegraphics[width=0.45\textwidth]{images/treshold/0_tresh_binared.png} };
	\zoombox[magnification=10]{0.15,0.8}
	\zoombox[magnification=10]{0.5,0.25}
	\end{tikzpicture}
