...
Bei einem feedforward Netzwerk werden die Daten im Netz immer vorwärts übertragen.Ein feedback Netzwerk, auch bekannt als \textit{Recurrent Neural Networks}, kann dagegen Daten rückwärts sowie in einer Schleife zum selben Neuron, übergeben \cite{goodfellowDeepLearning2016}. Da feedback Netzwerke keinen Einsatz in dieser Arbeit haben, ist im weiteren Verlauf dieser Arbeit bei einem Netzwerk immer ein feedforward Ansatz gemeint. 
