...
\begin{figure}[H]
	...
	\caption{Als Beispiel für ein Convolutional Neural Network wird die LeNet-5 Architektur wird abgebildet. Entnommen aus \cite{lecunGradientBasedLearningApplied1998}  }
	\label{fig:lenet5}
\end{figure}
