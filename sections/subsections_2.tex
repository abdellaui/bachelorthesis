...
\begin{figure}[H]
	...
	\caption{Beispiel für ein Convolutional Neural Network. Die LeNet-5 Architektur wird abgebildet. Entnommen aus \cite{lecunGradientBasedLearningApplied1998}  }
	\label{fig:lenet5}
\end{figure}
